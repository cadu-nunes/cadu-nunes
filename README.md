...
<h3 align="center"> 🎯 Bacharel em Química pela USP & Desenvolvedor em formação. </h3>
...
<p align="center">
  ...
  Atualmente estudo Desenvolvimento de Sistemas no SENAI-SP e me dedico a aprender e aplicar:
- 🐍 Python para automação, análise de dados, visualização e scripts de ETL
- 🗃️ SQL para manipulação, modelagem e consultas em bancos relacionais
- 📊 Projetos pessoais com dados abertos e foco em boas práticas, clareza e reprodutibilidade

  Aqui você vai encontrar meus projetos, estudos e experimentos com dados, todos desenvolvidos com cuidado, documentação clara e muito aprendizado envolvido.
